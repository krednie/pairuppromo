...
const SwipeJoinSection = lazy(() =>
  import("../components/SwipeJoinSection").then((module) => ({ default: module.SwipeJoinSection })),
)
...
export default function LandingPage() {
  ...
  useDocumentMetadata(
    "PairUp - Find the people to build with",
    "PairUp helps university builders find the people they need to turn ideas into real projects.",
    "/",
  )
  ...
  return (
    <div ref={rootRef} className="app-shell">
      ...
      <main id="main-content">
        ...
        <CollisionSection />
        <MomentumSection />
        <Suspense fallback={<section id="join" className="swipe-join-section swipe-join-loading" aria-hidden="true" />}>
          <SwipeJoinSection />
        </Suspense>
      </main>
      <SiteFooter />
